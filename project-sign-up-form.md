# Intermediate HTML and CSS ([#Link](https://www.theodinproject.com/paths/full-stack-javascript/courses/intermediate-html-and-css))

## PROJECT: SIGN-UP FORM ([#Link](https://www.theodinproject.com/paths/full-stack-javascript/courses/intermediate-html-and-css/lessons/sign-up-form))

- [Source](https://github.com/TheOdinProject/curriculum/blob/main/html_css/project-sign-up-form/project-sign-up-form.md)
